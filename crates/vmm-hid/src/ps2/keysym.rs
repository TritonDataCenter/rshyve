...
//
// Copied from Propolis, used under MPL-2.0.
// Upstream: crates/rfb/src/keysym.rs
...
// XXX(JPH): meta keys are not handled. Support may be needed.
...
impl TryFrom<u32> for KeySym {
    ...
    fn try_from(value: u32) -> Result<Self, Self::Error> {
        match value {
            // SAFETY: this arm matches only values in the ASCII range.
            0..=ASCII_MAX => {
